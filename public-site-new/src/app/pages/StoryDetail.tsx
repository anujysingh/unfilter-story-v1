...
export default function StoryDetail() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/stories" className="text-[#FF4D8D] font-medium flex items-center gap-2">
  ...
  const relatedStories = mockStories.filter((s) => s.id !== id).slice(0, 3);
          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center justify-between mb-10 pb-8 border-b border-[#EAEAEA]">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-[#111111]">{story.author}</p>
                  <p className="text-sm text-[#6B6B6B]">Founder / Entrepreneur</p>
                </div>
              </div>
              <ShareButtons url={window.location.href} title={story.title} />
            </div>
